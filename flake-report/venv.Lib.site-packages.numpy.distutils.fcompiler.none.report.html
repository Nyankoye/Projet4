      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.distutils.fcompiler.none.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.distutils.fcompiler.none.source.html#l6">
                  <tt><i>6</i> <span class="k">class</span> <span class="nc">NoneFCompiler</span><span class="p">(</span><span class="n">FCompiler</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
