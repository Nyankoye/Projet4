...
<html>
   <head>
      <title>flake8 violations: .\venv\Lib\site-packages\pandas\core\arrays\categorical.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pandas.core.arrays.categorical.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pandas.core.arrays.categorical.source.html#l1766">
                  <tt><i>1766</i>         <span class="n">tail</span> <span class="o">=</span> <span class="bp">self</span><span class="p">[</span><span class="o">-</span><span class="p">(</span><span class="n">max_vals</span> <span class="o">-</span> <span class="n">num</span><span class="p">)</span> <span class="p">:]</span><span class="o">.</span><span class="n">_get_repr</span><span class="p">(</span><span class="n">length</span><span class="o">=</span><span class="kc">False</span><span class="p">,</span> <span class="n">footer</span><span class="o">=</span><span class="kc">False</span><span class="p">)</span></tt>
               </a>
            </li>
            </ul>
         </li>
