...
<html>
   <head>
      <title>flake8 violations: .\venv\Lib\site-packages\astroid\brain\brain_numpy_ndarray.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.astroid.brain.brain_numpy_ndarray.source.html">
         ...
         <li>
            <a data-code="F401">
               ...
               <strong>F401:</strong> 'functools' imported but unused
               
            </a>
            <ul class="details">
            <li>
               
               <a href="venv.Lib.site-packages.astroid.brain.brain_numpy_ndarray.source.html#l11">
                  <tt><i>11</i> <span class="kn">import</span> <span class="nn">functools</span></tt>
               </a>
            </li>
            </ul>
         </li>
