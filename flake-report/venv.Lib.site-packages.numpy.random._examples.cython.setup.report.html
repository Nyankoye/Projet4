      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.random._examples.cython.setup.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.random._examples.cython.setup.source.html#l35">
                  <tt><i>35</i>                          <span class="p">)</span></tt>
               </a>
            </li>
            </ul>
         </li>
