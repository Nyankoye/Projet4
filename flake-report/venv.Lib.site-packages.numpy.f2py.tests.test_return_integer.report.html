      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.f2py.tests.test_return_integer.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.f2py.tests.test_return_integer.source.html#l28">
                  <tt><i>28</i>         <span class="c1">#assert_raises(ValueError, t, array([123],&#39;S3&#39;))</span></tt>
               </a>
            </li>
            </ul>
         </li>
