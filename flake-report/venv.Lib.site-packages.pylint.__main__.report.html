...
<html>
   <head>
      <title>flake8 violations: .\venv\Lib\site-packages\pylint\__main__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pylint.__main__.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               .\venv\Lib\site-packages\pylint\__main__.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pylint.__main__.source.html#l4">
                  <tt><i>4</i> <span class="c1">#!/usr/bin/env python</span></tt>
               </a>
            </li>
            </ul>
         </li>
