      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.random.tests.test_direct.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.random.tests.test_direct.source.html#l129">
                  <tt><i>129</i> <span class="k">def</span> <span class="nf">test_seedsequence</span><span class="p">():</span></tt>
               </a>
            </li>
            </ul>
         </li>
