...
<html>
   <head>
      <title>flake8 violations: .\venv\Lib\site-packages\pygments\styles\fruity.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.styles.fruity.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.styles.fruity.source.html#l16">
                  <tt><i>16</i> <span class="k">class</span> <span class="nc">FruityStyle</span><span class="p">(</span><span class="n">Style</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
