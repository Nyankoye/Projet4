...
<html>
   <head>
      <title>flake8 violations: .\venv\Lib\site-packages\pygments\lexers\actionscript.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.lexers.actionscript.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.lexers.actionscript.source.html#l119">
                  <tt><i>119</i> <span class="k">class</span> <span class="nc">ActionScript3Lexer</span><span class="p">(</span><span class="n">RegexLexer</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
