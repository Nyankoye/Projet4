...
<html>
   <head>
      <title>flake8 violations: .\venv\Lib\site-packages\numpy\distutils\tests\test_fcompiler_intel.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.distutils.tests.test_fcompiler_intel.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.distutils.tests.test_fcompiler_intel.source.html#l17">
                  <tt><i>17</i> <span class="k">class</span> <span class="nc">TestIntelFCompilerVersions</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
