      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.doc.basics.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.doc.basics.source.html#l267">
                  <tt><i>267</i> <span class="sd">requires more memory than available in the data type. For example, </span></tt>
               </a>
            </li>
            </ul>
         </li>
