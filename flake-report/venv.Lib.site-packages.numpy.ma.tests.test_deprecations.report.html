      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.ma.tests.test_deprecations.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.ma.tests.test_deprecations.source.html#l9">
                  <tt><i>9</i> <span class="k">class</span> <span class="nc">TestArgsort</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
