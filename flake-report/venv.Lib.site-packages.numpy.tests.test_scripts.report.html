      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.tests.test_scripts.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.tests.test_scripts.source.html#l20">
                  <tt><i>20</i>         <span class="k">if</span> <span class="n">exe_dir</span><span class="o">.</span><span class="n">endswith</span><span class="p">(</span><span class="s1">&#39;Scripts&#39;</span><span class="p">):</span> <span class="c1"># virtualenv</span></tt>
               </a>
            </li>
            </ul>
         </li>
