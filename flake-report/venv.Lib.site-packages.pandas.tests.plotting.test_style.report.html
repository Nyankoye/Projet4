...
<html>
   <head>
      <title>flake8 violations: .\venv\Lib\site-packages\pandas\tests\plotting\test_style.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pandas.tests.plotting.test_style.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pandas.tests.plotting.test_style.source.html#l6">
                  <tt><i>6</i> <span class="kn">from</span> <span class="nn">pandas.plotting._matplotlib.style</span> <span class="kn">import</span> <span class="n">get_standard_colors</span></tt>
               </a>
            </li>
            </ul>
         </li>
