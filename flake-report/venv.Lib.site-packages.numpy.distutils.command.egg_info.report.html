      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.distutils.command.egg_info.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.distutils.command.egg_info.source.html#l5">
                  <tt><i>5</i> <span class="k">class</span> <span class="nc">egg_info</span><span class="p">(</span><span class="n">_egg_info</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
