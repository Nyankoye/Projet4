      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.doc.glossary.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.doc.glossary.source.html#l173">
                  <tt><i>173</i> <span class="sd">       Describes a block of memory comprised of blocks, each block comprised of </span></tt>
               </a>
            </li>
            </ul>
         </li>
