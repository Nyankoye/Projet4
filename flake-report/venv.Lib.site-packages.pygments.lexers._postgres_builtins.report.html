...
<html>
   <head>
      <title>flake8 violations: .\venv\Lib\site-packages\pygments\lexers\_postgres_builtins.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.pygments.lexers._postgres_builtins.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.pygments.lexers._postgres_builtins.source.html#l625">
                  <tt><i>625</i>                     <span class="k">if</span> <span class="ow">not</span> <span class="n">t</span><span class="p">:</span> <span class="k">continue</span></tt>
               </a>
            </li>
            </ul>
         </li>
