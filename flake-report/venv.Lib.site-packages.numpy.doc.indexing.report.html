      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.doc.indexing.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.doc.indexing.source.html#l296">
                  <tt><i>296</i> <span class="sd">followed by the index array operation which extracts rows with </span></tt>
               </a>
            </li>
            </ul>
         </li>
