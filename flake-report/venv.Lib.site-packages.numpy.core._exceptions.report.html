      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.core._exceptions.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.core._exceptions.source.html#l10">
                  <tt><i>10</i> <span class="k">def</span> <span class="nf">_unpack_tuple</span><span class="p">(</span><span class="n">tup</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
