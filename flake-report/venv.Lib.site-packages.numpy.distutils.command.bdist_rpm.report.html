      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.distutils.command.bdist_rpm.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.distutils.command.bdist_rpm.source.html#l8">
                  <tt><i>8</i> <span class="k">class</span> <span class="nc">bdist_rpm</span><span class="p">(</span><span class="n">old_bdist_rpm</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>
