      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="venv.Lib.site-packages.numpy.core.tests.test__exceptions.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="venv.Lib.site-packages.numpy.core.tests.test__exceptions.source.html#l12">
                  <tt><i>12</i> <span class="k">class</span> <span class="nc">TestArrayMemoryError</span><span class="p">:</span></tt>
               </a>
            </li>
            </ul>
         </li>
